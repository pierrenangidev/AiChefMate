...
export const Data = {
    content: {
            ...
            sections: {
                ...
                howItWorks: { 
                    ...
                    content: {
                        step1: {
                            ...
                            content: "Begin by creating your profile. Tell us about your dietary preferences, nutritional goals, and budget. Our AI technology tailors every meal plan to fit your unique needs."
                        },
                        step2: {
                            numberTitle: "02",
                            title: "Customize Your Plan",
                            content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque euismod, nisi eu consectetur cursus, nisl erat facilisis urna, vitae dictum enim enim nec urna. Suspendisse potenti."
                        },
                        step3: {
                            numberTitle: "03",
                            title: "Enjoy Your Meals",
                            content: "Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Nullam id dolor id nibh ultricies vehicula ut id elit. Etiam porta sem malesuada magna mollis euismod."
                        },
                        images: {
                ...
                testimonials: {
                    ...
                    content: {
                        testimonial1: {
                            name: "Emily R.",
                            feedback: "Since using AIChefMate, I've rediscovered my love for cooking! The meal plans are easy and delicious. It's been a game-changer for my busy lifestyle."
                        },
                        testimonial2: {
                            name: "Mark T.",
                            feedback: "I never knew healthy eating could be this simple and satisfying. Thanks to AIChefMate, my family enjoys diverse, nutritious meals every day."
                        },
                        testimonial3: {
                            name: "Sarah J.",
                            feedback: "The grocery savings have been incredible! Plus, every meal feels tailored just for me. I'm eating better and feeling great. A big thumbs up!"
                        },
                        testimonial4: {
                            name: "Rebecca S.",
                            feedback: "Switching to AIChefMate has been a revelation for my meal prep routine. The AI-generated plans are spot-on with my tastes and nutritional needs, making healthy eating effortless and enjoyable."
                        },
                        images: {
                ...
                pricing: {
                    ...
                    content: {
                        plan1: {
                            ...
                            bestFor: "Those who want to explore the platform's basic functionalities.",
                        ...
                        plan2: {
                            ...
                            bestFor: "Individuals or families looking for full meal planning support and convenience.",
                        ...
                        plan3: {
                            ...
                            bestFor: "Users seeking a premium culinary experience with added personalization and expert guidance.",
                ...
                faq: {
                    ...
                    content: {
                        question1: {
                            question: "How does the AI personalize my meal plans?",     
                        ...
                        question3: {
                            ...
                            answer: "Our grocery delivery service is designed to be seamless and convenient. Once your meal plan is created, you can choose to have all the necessary ingredients delivered to your doorstep. We partner with local grocery stores and delivery services to ensure fresh and high-quality ingredients are available for your meals."
                        },
                        question4: {
                            question: "How does the platform accommodate allergies and food sensitivities?",
                            answer: "The AI analyzes your dietary preferences, restrictions, and goals to create customized meal plans just for you."
                        },
                        question5: {
                        ...
                        question6: {
                            ...
                            answer: "Our AI takes food allergies into account when creating your meal plan, ensuring your safety and satisfaction."
                        },
                        question7: {
                            question: "How can I access nutrition education and healthy eating tips?",     
                            answer: "Our platform offers a wealth of resources, including articles, videos, and personalized recommendations to help you make informed food choices and develop healthy eating habits."
                        },
                        question8: {
                            question: "What makes your AI-driven meal planning different from other meal planning services?",
                            answer: "Our AI-driven meal planning is unique because it offers personalized meal plans that adapt to your specific dietary needs, preferences, and goals. We also provide ongoing support and resources to help you maintain a healthy lifestyle."
                        }
                    },
                },
                needAssistance: {
        ...
        footer: {
            content: {
                description: "Join us on our journey to make meal planning simple and joyful. Connect with us on social media, explore our FAQs for quick answers, or drop us a line anytime.",
                copyright: "© 2064 AIChefMate. All rights reserved. | Privacy Policy | Terms of Use",
                links: [
                    { 
